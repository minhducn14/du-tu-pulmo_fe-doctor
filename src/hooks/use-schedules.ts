...
export const SCHEDULE_KEYS = {
    ...
    regular: (doctorId: string) => [...SCHEDULE_KEYS.list(doctorId), 'regular'] as const,
    flexible: (doctorId: string) => [...SCHEDULE_KEYS.list(doctorId), 'flexible'] as const,
    timeOff: (doctorId: string) => [...SCHEDULE_KEYS.list(doctorId), 'timeOff'] as const,
};
...
export function useCreateRegularSchedule() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, data }: { doctorId: string; data: CreateScheduleDto }) =>
...
export function useBulkCreateRegularSchedules() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, schedules }: { doctorId: string; schedules: CreateScheduleDto[] }) =>
...
export function useCreateFlexibleSchedule() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, data }: { doctorId: string; data: CreateFlexibleScheduleDto }) =>
...
export function useCreateTimeOff() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, data }: { doctorId: string; data: CreateTimeOffDto }) =>
...
export function useUpdateRegularSchedule() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, id, data }: { doctorId: string; id: string; data: UpdateScheduleDto }) =>
...
export function useUpdateFlexibleSchedule() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, id, data }: { doctorId: string; id: string; data: Partial<CreateFlexibleScheduleDto> }) =>
...
export function useUpdateTimeOff() {
    ...
    return useMutation({
        mutationFn: ({ doctorId, id, data }: { doctorId: string; id: string; data: Partial<CreateTimeOffDto> }) =>
...
export function useGenerateSlots() {
    return useMutation({
        mutationFn: ({ doctorId, data }: { doctorId: string; data: GenerateSlotsDto }) =>
